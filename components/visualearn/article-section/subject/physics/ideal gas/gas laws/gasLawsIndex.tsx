...
import GasLawsContent from './gasLawsContent'
...
const topic = {
  ...
  description: {
    en: "Gas Laws describe the behavior of gases under varying conditions of pressure, volume, and temperature.",
    bn: "গ্যাসের সূত্র চাপ, আয়তন এবং তাপমাত্রার বিভিন্ন অবস্থায় গ্যাসের আচরণ বর্ণনা করে।"
  },
  hasSimulation: true,
  hasQuiz: true
}

export default function GasLawsIndex() {
  return (

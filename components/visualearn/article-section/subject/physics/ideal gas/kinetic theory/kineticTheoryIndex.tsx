...
import KineticTheoryContent from './kineticTheoryContent'
import KineticTheorySimulation from './kineticTheorySimulation'
import KineticTheoryQuiz from './kineticTheoryQuiz'
...
const topic = {
  ...
  description: {
    en: "Kinetic Theory explains gas behavior through the motion of particles.",
...
export default function KineticTheoryIndex() {
  return (

...
export default function SpringForceQuiz() {
  ...
  const questions = lang === "bn" ? [
    {
      question: "হুকের সূত্রের সূত্র কী?",
      options: [
        "F = ma",
        "F = -kx",
        "v = u + at",
    ...
    {
      question: "স্প্রিং ধ্রুবক কী নির্দেশ করে?",
      options: [
        "বস্তুর ভর",
        "স্প্রিংয়ের কঠোরতা",
        "বেগ",
    ...
    {
      question: "স্প্রিং বল কী ধরনের বল?",
      options: [
        "ঘর্ষণ বল",
        "পুনরুদ্ধারী বল",
        "মাধ্যাকর্ষণ বল",
    ...
    {
      question: "What does the spring constant indicate?",
      options: [
        "Mass of the object",
    ...
    {
      question: "What type of force is the spring force?",
      options: [
        "Frictional force",
        "Restoring force",
        "Gravitational force",

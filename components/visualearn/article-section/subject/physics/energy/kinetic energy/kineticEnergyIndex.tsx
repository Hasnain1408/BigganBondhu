...
import KineticEnergyContent from './kineticEnergyContent'
import KineticEnergySimulation from './kineticEnergySimulation'
import KineticEnergyQuiz from './kineticEnergyQuiz'
...
const topic = {
  ...
  description: {
    ...
    bn: "গতিশক্তি হল কোনো বস্তুর গতির কারণে তার শক্তি।"
  },
  hasSimulation: true,
  hasQuiz: true
}

export default function KineticEnergyIndex() {
  return (

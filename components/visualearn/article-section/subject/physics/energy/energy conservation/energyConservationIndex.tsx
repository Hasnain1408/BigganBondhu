...
import EnergyConservationContent from './energyConservationContent'
import EnergyConservationSimulation from './energyConservationSimulation'
import EnergyConservationQuiz from './energyConservationQuiz'
...
const topic = {
  ...
  description: {
    ...
    bn: "শক্তি সংরক্ষণের সূত্র বলে যে একটি বিচ্ছিন্ন ব্যবস্থার মোট শক্তি স্থির থাকে।"
  },
  hasSimulation: true,
  hasQuiz: true
}

export default function EnergyConservationIndex() {
  return (

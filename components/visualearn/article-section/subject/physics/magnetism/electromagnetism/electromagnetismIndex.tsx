...
import ElectromagnetismContent from './electromagnetismContent'
import ElectromagnetismSimulation from './electromagnetismSimulation'
import ElectromagnetismQuiz from './electromagnetismQuiz'
...
export default function ElectromagnetismIndex() {
  return (

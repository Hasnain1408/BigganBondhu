...
import PendulumSimulation from "./simulation/PendulumSimulation"
import WaveSimulation from "./simulation/WaveSimulation"
import DopplerEffectSimulation from "./simulation/DopplerEffectSimulation"
import ProjectileMotionSimulation from "./simulation/ProjectileMotionSimulation"
import RelativeMotionSimulation from "./simulation/RelativeMotionSimulation"
import FrictionSimulation from "./simulation/frictionSimulation"
import ProjectileQuiz from "./quiz/projectileQuiz"
...
export default function TopicContent({ subject, chapter, topic }: TopicContentProps) {
  ...
  const renderVisualization = () => {
    ...
    if (subject === "physics" && chapter === "force" && topic.id === "friction") {
